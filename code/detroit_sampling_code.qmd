...
# bg-level composite mos (same match() pattern)
ssu_frame <- ssu_frame |>
...
# Anticipated Precision (VDK Ch. 9) {#sec-precision}
...
# Variance Estimation (Lecture Ch. 9; VDK Ch. 15) {#sec-variance}
