...
\CommentTok{\#api\_keys \textless{}{-} read\_csv("D:/repos/api{-}keys.csv", show\_col\_types = FALSE)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#kevin\_input\_path \textless{}{-} "D:/repos/eight{-}mile{-}sample/inputs/"}
\NormalTok{tavril\_input\_path }\OtherTok{\textless{}{-}} \StringTok{"C:/Users/tavri/Documents/SURV745/eight{-}mile{-}sample/inputs/"}
...
\NormalTok{tract\_fips }\OtherTok{\textless{}{-}} \FunctionTok{read\_csv}\NormalTok{(}
  \FunctionTok{str\_c}\NormalTok{(tavril\_input\_path, }\CommentTok{\# change this as needed}
...
\NormalTok{tract }\OtherTok{\textless{}{-}} \FunctionTok{read\_excel}\NormalTok{(}
  \FunctionTok{str\_c}\NormalTok{(tavril\_input\_path,}
